...
- Account access: use the Account page and sign in with a one-time email link to see scans tied to your purchase email
...
- If someone asks how to access unused scans later, tell them they can use the Account page with a one-time email sign-in link, or use the direct recovery link. Do not expose raw route paths unless they explicitly ask for a link.
